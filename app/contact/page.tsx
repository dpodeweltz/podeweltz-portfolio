  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const result = await emailjs.send(
        "service_ow8z1uh", // Replace with your EmailJS Service ID
        "template_jpr7zz8", // Replace with your EmailJS Template ID
        {
          name: formData.name,
        ...
        "vWi3FDJEaBFZ-rHQm" // Replace with your EmailJS Public Key
      );
